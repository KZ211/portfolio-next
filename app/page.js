        ...
        <div className="flex justify-between items-center">  
          <Image 
            ...
            <secction className='text-center mt-14 ml-10 mr-72 text-white'>
              ...
              <p className="text-lg backdrop-filter backdrop-blur-lg backdrop-saturate-100 rounded-xl">Hola, me llamo Alexis Jares, soy estudiante de Ingenieria en Computacion en la Universidad de Tres de Febrero (UNTREF) Y desarrollador web, la tecnologia es mi pasion desde muy pequeño, por eso sacrifique todo para trabajar en el area que tanto me apasiona. <br/> 
