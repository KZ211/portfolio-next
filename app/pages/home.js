...
export default function HomePage(){
    ...
    return <>
        <header id='home' className="hidden snap-center lg:flex md:flex-row justify-center items-center pb-40 pt-5">
        <div className="flex sm:flex-row md:flex-row lg:flex-row justify-between items-center">  
            <div className="flex flex-row items-center">
            <Image className="mr-5 mt-4 rounded-xl animate__animated animate__fadeInLeft animate-slow"
            src={myImage}
            alt="Photograph of Alexis looking to the right while walking on a sidewalk" 
            width={300} 
            height={300}/>
            <section className="text-white text-center animate__animated animate__fadeInRight animate-slow">
            <h1 className="
            ...
            <h3 className="text-2xl transition-all ease-in duration-300 hover:text-3xl" ><b>React Frontend Developer</b></h3>
            </section>
