...
export default function HomePage(){
    ...
    <div className="self-start grid-row-span-1 row-start-3 row-end-3 
      ...
      <div className="container text-md max-w-lg
                      sm:flex sm:content-center sm:text-2xl sm:max-w-2xl">
      
        <p className="uppercase font-semibold">I&apos;m a Computer Engineering student at the University of Tres de Febrero (UNTREF) and a web developer. Technology has been my passion since I was very young, which is why I&apos;ve sacrificed everything to work in a field that i adore.</p>
      </div>
    </div>
    <div className="self-center grid-row-span-1
      ...
      <div className="container text-md row-start-4 row-end-4
        ...
        <p className="uppercase font-semibold underline text-lg"> React Frontend Developer </p>
      </div>
    </div>
