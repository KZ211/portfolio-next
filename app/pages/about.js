export default function AboutPage(){
    ...
    <div className='font-monserrat py-10 xl:px-2 grid grid-rows-3 grid-cols-1 zIndex
                    sm:grid-cols-2 ml-2 lg:mx-auto'>
        <div className="mt-5 self-center grid-row-span-1 ">
        <div className="container overflow-hidden">
        <h2 className="font-monserrat text-ms uppercase font-semibold my-0">about</h2>
        </div>
        </div>
        <div className="mt-5 self-center grid-row-span-1 
        ...
        <div className="container overflow-hidden">
            <h3 className="text-3xl uppercase font-bold my-0
                            sm:text-5xl sm:max-w-2xl md:max-w-md lg:max-w-md xl:max-w-xl 2xl:max-w-3xl"
